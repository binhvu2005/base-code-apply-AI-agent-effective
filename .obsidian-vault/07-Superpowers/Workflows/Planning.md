...
### BƯỚC 1: ĐỌC LẠI SPEC & NHẬN DANH SÁCH TÁC VỤ (AI làm)

- Mở file Spec đã duyệt: `.obsidian-vault/07-Superpowers/Specs/YYYY-MM-DD-<topic>-design.md`
- **Đầu vào quan trọng nhất:** Đọc trực tiếp phần **Spec to Plan Checklist** ở Bước 6 của tài liệu Spec. Đây là khung xương của các tasks cần triển khai.
- Liệt kê tất cả các thành phần tương ứng từ Spec:
  - Database tables
  - API endpoints
  - UI components
  - Business logic
